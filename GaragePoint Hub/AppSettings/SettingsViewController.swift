...
//    var settingImgs = ["h","a","c","f","s","p"]
    ...
    override func viewDidLoad() {
        ...
        settingList = ["Dashboard", "Our Mission", "Clear All", "Feedback Hub", "Spread the Word", "Data Protection"]
...
//        applyGradientToButtonTwo(UIButton:  )
    ...
    private func NavToWelcome() {
        ...
        private func clearUserData() {
            ...
            UserDefaults.standard.removeObject(forKey: "RepairDetails")
            UserDefaults.standard.removeObject(forKey: "EmployeeDetails")
            UserDefaults.standard.removeObject(forKey: "SaleOrPurchaseRecords")
...
//            UserDefaults.standard.removeObject(forKey: "lectures")
        ...
        private func showResetConfirmation() {
            let confirmationAlert = UIAlertController(title: "Reset Complete", message: "Your all records has been reset successfully.", preferredStyle: .alert)
...
//       cell.sMenuImgs?.image = UIImage(named: settingImgs[indexPath.row])
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.item == 0 {
            ...
            let alert = UIAlertController(title: "Reset All Data", message: "Are you sure you want to delete all the data? This action cannot be undone.", preferredStyle: .alert)
            ...
            let appID = "GaragePointHub" // Replace with your actual App ID
